...
INSERT INTO `construction_company`.`employee` (`Personal_id_Number`, `Length_of_service`, `Salary`, `Bank_account`, `Profession`, `Hourly_rate`) VALUES ('1234567891011', '2', '0', '4512684558841', 'Engineer', '10');
INSERT INTO `construction_company`.`employee` (`Personal_id_Number`, `Length_of_service`, `Salary`, `Bank_account`, `Profession`, `Hourly_rate`) VALUES ('1111111111111', '4', '0', '8545484545454', 'Worker', '5');
INSERT INTO `construction_company`.`employee` (`Personal_id_Number`, `Length_of_service`, `Salary`, `Bank_account`, `Profession`, `Hourly_rate`) VALUES ('2222222222222', '3', '0', '4975124612545', 'Bricklayer', '6');
INSERT INTO `construction_company`.`employee` (`Personal_id_Number`, `Length_of_service`, `Salary`, `Bank_account`, `Profession`, `Hourly_rate`) VALUES ('3333333333333', '1', '0', '2342472383753', 'Driver', '5');
...
create view employees_without_account as SELECT person.Personal_id_Number,First_Name, Last_Name FROM person where person.Personal_id_Number not in(select user_account.Personal_id_Number from user_account);